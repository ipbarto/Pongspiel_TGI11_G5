...
public class GUI_RechtwinkligesDreieckStufe4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUI_RechtwinkligesDreieckStufe4 frame = new GUI_RechtwinkligesDreieckStufe4();
	 ...
	 * Create the frame.
	 */
	public GUI_RechtwinkligesDreieckStufe4() {
		...
		objRechtwinkligesDreieck = new fachklasse_rechtwinkligesDreieck(12.6 ,5.5);
	...
	private void berechnen()
	{
		...
		// Eingabe set_Methode verwenden
		/*
		double kath = Double.parseDouble(tfKatheteA.getText()); 
		objRechtwinkligesDreieck.setKathetheA(kath);    // Double.parseDouble() wandelt einen String um in Double-Datentyp
		
		double hyp = Double.parseDouble(tfHypotenuse.getText());
		objRechtwinkligesDreieck.setHypotenuse(hyp);           
		
		*/
		if (objRechtwinkligesDreieck.getHypotenuse() > objRechtwinkligesDreieck.getkatheteA())  // ok
		{
			/*
			...
			*/
			...
			tfKatheteA.setText(nk3.format(objRechtwinkligesDreieck.getkatheteA()));
			tfHypotenuse.setText(nk3.format(objRechtwinkligesDreieck.getHypotenuse()));
		...
		else
		{
			...
			tfHypotenuse.setText(nk3.format(objRechtwinkligesDreieck.getkatheteA()));
			tfKatheteA.setText(nk3.format(objRechtwinkligesDreieck.getHypotenuse()));
