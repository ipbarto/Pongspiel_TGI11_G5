...
public class GUI_Parallelschaltung extends JFrame {
	...
	public void Berechne() {
		...
		String Wider1string= "";
		String Wider2string= "";
		String spannungString = "";

		if(tfWider1.getText().isEmpty()==false && tfWider2.getText().isEmpty()==false && tfSpannung.getText().isEmpty()==false) {
			 ...
			 */
			objParallelschaltung_rechner = new fachklasse_Parallelschaltung(WIder1, Wider2, Spannung);
		}
		else {
			if(tfWider1.getText().isEmpty()==true) {
				Wider1string = " Wiederstand 1 ";
			}
			if(tfWider2.getText().isEmpty()==true) {
				Wider2string = " Wiederstand 2 ";
			}
			if(tfSpannung.getText().isEmpty()==true) {
				spannungString = " Spannung ";
			}
			
			JOptionPane.showMessageDialog(null, "Eingabe von" + Wider1string + Wider2string + spannungString + "fehlen");
		}
