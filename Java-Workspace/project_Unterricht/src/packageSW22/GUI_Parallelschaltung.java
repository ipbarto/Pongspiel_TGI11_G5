...
public class GUI_Parallelschaltung extends JFrame {
	...
	private Parallelschaltung_rechner objParallelschaltung_rechner;
	...
	public GUI_Parallelschaltung() {
		...
		objParallelschaltung_rechner = new Parallelschaltung_rechner();
	}
	...
	public void Berechne() {
		...
		objParallelschaltung_rechner.U = Double.parseDouble(tfSpannung.getText());
		objParallelschaltung_rechner.R1 = Double.parseDouble(tfWider1.getText());
		objParallelschaltung_rechner.R2 = Double.parseDouble(tfWider2.getText());

		if (objParallelschaltung_rechner.R1 != 0 && objParallelschaltung_rechner.R2 != 0) {
				...
				tfGesWider.setText(nk3.format(objParallelschaltung_rechner.Rges));
				tfGesStrom.setText(nk3.format(objParallelschaltung_rechner.Iges));
