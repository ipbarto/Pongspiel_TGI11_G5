...
public class GUI_RechtwinkligesDreieck_Mit_Berechnungsmethoden_mitAttrubten extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUI_RechtwinkligesDreieck_Mit_Berechnungsmethoden_mitAttrubten frame = new GUI_RechtwinkligesDreieck_Mit_Berechnungsmethoden_mitAttrubten();
	 ...
	 * Create the frame.
	 */
	public GUI_RechtwinkligesDreieck_Mit_Berechnungsmethoden_mitAttrubten() {
	...
	private void berechnen()
	{
		...
		// Eingabe
		katheteA =     Double.parseDouble(tfKatheteA.getText()      )  ;    // Double.parseDouble() wandelt einen String um in Double-Datentyp
		hypotenuseC =     Double.parseDouble(tfHypotenuse.getText()       )  ;

		if (hypotenuseC > katheteA)  // ok
		{
			/*
		...
		else
		{
			...
			tfHypotenuse.setText(nk3.format(katheteA));
			tfKatheteA.setText(nk3.format(hypotenuseC));
