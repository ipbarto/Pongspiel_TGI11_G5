...
public class GUI_rechtwinkl extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUI_rechtwinkl frame = new GUI_rechtwinkl();
	...
	public GUI_rechtwinkl() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(GUI_rechtwinkl.class.getResource("/packageSW18/Parallelschaltung_Widerstände.svg.png")));
