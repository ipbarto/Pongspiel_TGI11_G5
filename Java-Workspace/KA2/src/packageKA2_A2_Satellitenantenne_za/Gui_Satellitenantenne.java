package packageKA2_A2_Satellitenantenne_za;
...
public class Gui_Satellitenantenne extends JFrame {
	...
	public void guivariablen() {
		...
		if(tfKabellaenge.getText().isEmpty()==false) {
	...
	private double clickberechnekosten() {
		...
		if(cm60) {
			...
			JOptionPane.showMessageDialog(null, "Bitte Durchmesser wählen");
		}
		...
		if(kabel) {
			...
			if (kabellaenge==0) {
				JOptionPane.showMessageDialog(null, "kabellänge angeben");
			}
		}
	...
	private void clickAngebotmitText() {
		...
		double kabelerneut;
		DecimalFormat nk2 = new DecimalFormat("0.00");
		if((cm60||cm80||cm100) && (ziegelrot||hellgrau||antharzit)) {
			...
			JOptionPane.showMessageDialog(null, "Bitte Durchmesser/Farbe wählen");
		}
